 ...
 * @example ```ts
 * import { randomInteger } from "https://deno.land/x/911@0.1.4/src/math.ts";
 *
 ...
 * @example ```ts
 * import { clamp } from "https://deno.land/x/911@0.1.4/src/math.ts";
 *
 * clamp(0, 1, 3) // => 1
 * clamp(1, 1, 3) // => 1
 * clamp(2, 1, 3) // => 2
 ...
 * @example ```ts
 * import { sum } from "https://deno.land/x/911@0.1.4/src/math.ts";
 *
 * sum([1, 2, 3, 4, 5]);
 * // 15
 * ```
